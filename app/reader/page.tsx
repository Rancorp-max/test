      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        {pdf ? (
          <div className="border rounded-xl overflow-hidden shadow-sm">
            <iframe src={pdf + '#toolbar=0&navpanes=0'} style={{ width:'100%', height: '80vh', transform: `scale(${zoom})`, transformOrigin: 'top left' }} />
          </div>
        ) : images.length ? (
          ...
          <div className="text-center text-slate-500">No content. Open this page with <code>?pdf=</code> or <code>?images=</code>.</div>
        )}
      </main>
      <style jsx global>{`
        @media print {
